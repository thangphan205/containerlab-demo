...
```mermaid
graph TD
    subgraph LAN Segment (10.0.10.0/24)
    ...
    subgraph WAN / Backbone Segment
        r1 -- eth2 (10.0.12.1/24) --- eth1[backbone<br>10.0.12.2/24]
        r2 -- eth2 (10.0.13.1/24) --- eth2[backbone<br>10.0.13.2/24]
    end
```
